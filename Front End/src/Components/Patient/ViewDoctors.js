...
class ViewDoctors extends React.Component{
    ...
    componentDidMount()
  {
    ...
    for(var i=0;i<json.length;i++)
    {
            ...
            var final = '<center><div class="card text-white bg-dark mb-3" style="max-width: 50rem;"><div class="card-header"style="color:blueviolet"<b>'+spe+'</b></div><div class="card-body"><h5 class="card-title">Dr. '+fn+" "+ln+'</h5><p class="card-text">  '+qua+' with '+exp+' years of Experience'+'</p><p class="card-text">Consultation Fees : ₹'+fees+'/-</p> <a href="/bookappointment?bdr_id='+bdr_id+'" class="btn btn-primary">Book Appoitment</a></div></div></center>'
