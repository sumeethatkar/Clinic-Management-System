...
password=(event)=>
{
  ...
  <div class="row">
    ...
    <h3><i>My Profile</i></h3>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRQqhlB3K44SR3hw30aQyZ1-9DGZvvMRbu4Q&usqp=CAU" class="img-responsive" height="480" width="350"/>
    </div>
  </div>
</div>
    ...
    <form id="contact-form" class="form-horizontal" role="form">
                ...
                <input type="text" class="form-control" id="name"value={this.state.contact_no} name="name" onChange={this.contact_no} required/>
                </div>
        */}
                <div class="form-outline mb-4">
