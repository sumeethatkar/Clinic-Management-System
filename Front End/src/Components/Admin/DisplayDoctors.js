    ...
    render(){
        return (
            ...
            <div>
                <NavbarAdmin/>
                <div>
                <h2 className="text-center">Doctors in Clinic</h2>
                <div className="row">
